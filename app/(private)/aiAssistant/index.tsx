...
import { CustomFlatList, Input, Text } from "@/components/index";
...
const AiAssistant = () => {
  ...
  useEffect(() => {
    ...
    states.messages[states.messages.length - 1]?.text,
  ]);
  ...
  return (
    <Container title="AI Assistant" showBackArrow scrollable={false}>
